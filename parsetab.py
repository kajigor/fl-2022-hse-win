...
_lr_productions = [
  ...
  ('expr -> START SEPARATOR','expr',2,'p_expr_start','parse.py',71),
  ('expr -> rule SEPARATOR','expr',2,'p_expr_rule','parse.py',79),
  ('rule -> mult_tokens TO mult_tokens','rule',3,'p_rule','parse.py',84),
  ('mult_tokens -> token','mult_tokens',1,'p_mtokens_token','parse.py',89),
  ('mult_tokens -> mult_tokens token','mult_tokens',2,'p_mtokens_mtokens_token','parse.py',94),
  ('token -> TERM','token',1,'p_token_term','parse.py',98),
  ('token -> NONTERM','token',1,'p_token_NONTERM','parse.py',104),
  ('token -> EPS','token',1,'p_token_eps','parse.py',110),
]
