...
2. Множество символов, из которые не встречаются во входных словах, но которые может печатать машина(в дополнение к символам из алфавита)
3. Пробельный символ, причём он не лежит в алфавите
